...
/**
 * Generated class for the BreakingDownPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-breaking-down',
  templateUrl: 'breaking-down.html',
})
export class BreakingDownPage {
  toolList: any;
  items = [];
  ...
  InsertQ1Item(QId) {
    ...
    if (value != "" && value != null && value != undefined) {
      let params = [value, enums.Page.BreakingDown,QId];
  ...
  updateItem(Data, Id) {
    if (Data != null && Data != undefined && Data != "") {
      let params = [Data, Id, enums.Page.BreakingDown];
  ...
  ListData() {
    let params = [enums.Page.BreakingDown];
  ...
  sendpage() {
    this.baseclass.displayAlert("", "Please enter an email address below", "BreakingDown")
  }
