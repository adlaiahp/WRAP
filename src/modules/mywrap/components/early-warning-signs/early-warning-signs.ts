...
/**
 * Generated class for the EarlyWarningSignsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-early-warning-signs',
  templateUrl: 'early-warning-signs.html',
})
export class EarlyWarningSignsPage {
  toolList: any;
  items = [];
  ...
  constructor(public navCtrl: NavController,
    ...
    this.events.subscribe("Tool:Save Completed", (data) => {
      if (data == "EarlyWarningSignsPage") {
        this.ListData();
      }
    });
    events.subscribe("Update:WarningSigns", (data) => {
  ...
  InsertQ1Item(QId) {
    ...
    if (value != "" && value != null && value != undefined) {
      let params = [value, enums.Page.WarningSigns,QId];
  ...
  updateItem(Data, Id) {
    if (Data != null && Data != undefined && Data != "") {
      let params = [Data, Id, enums.Page.WarningSigns];
  ...
  ListData() {
    let params = [enums.Page.WarningSigns];
  ...
  sendpage() {
    this.baseclass.displayAlert(" ", "Please enter an email address below", "EarlyWarningSigns")
  }
