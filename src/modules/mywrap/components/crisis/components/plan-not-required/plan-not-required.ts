...
/**
 * Generated class for the PlanNotRequiredPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-plan-not-required',
  templateUrl: 'plan-not-required.html',
})
export class PlanNotRequiredPage {
  ...
  constructor(public navCtrl: NavController,
    ...
    events.subscribe("Update:Crisis:PlanNoLonger", (data) => {
  ...
  InsertItem() {
    ...
    if (value != null && value != undefined && value != "") {
      let params = [value, enums.CrisisColumns.PlanNoLonger, enums.Crisis.PlanNoLonger];
  ...
  ListData() {
    let params = [enums.CrisisColumns.PlanNoLonger, enums.Crisis.PlanNoLonger];
  ...
  navigateright() {
    this.navCtrl.push("KeySignaturesPage");
  }
  sendpage() {
    this.baseclass.displayAlert(" ", "Please enter an email address below", "PlanNotRequired");
  }
}
